# Utilizare AI - Sisteme de Operare (Phase 1)

**Nume/Prenume:** Fizădean Alexandru
**Rol:** city_manager filter implementation
...
### 5. Ce am învățat
1. **Parsare avansată în C:** Am învățat cum funcționează parsatorul `%[^:]` din `sscanf`, care permite citirea caracterelor dintr-un string până la întâlnirea unui delimitator ales (în cazul acesta `:`).
